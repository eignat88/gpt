#!/usr/bin/env python3
"""X++/AOT class parsing and source-analysis primitives.

This module owns the class-level X++ parsing API.  Legacy modules such as
:mod:`xpp_analyzer.analyzer` and :mod:`xpp_analyzer.analysis` re-export these
